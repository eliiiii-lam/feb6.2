        ...
        while (opModeIsActive()) {
            ...
            switch (pipeline.getAnalysis()) {
                case LEFT:
                    ...
                    elbowDrive(DRIVE_SPEED,-20,4);
                    sleep(300);
                    driveStraight(DRIVE_SPEED,-5.2,90);
                    ...
                    elbowDrive(0.8,78,3);
                    clawL.setPosition(0);
                    elbowDrive(DRIVE_SPEED, -25,3.0);
                    encoderDrive(DRIVE_SPEED,-24,24,24,-24,2.0);
                    turnToHeading(TURN_SPEED,-90);
*/
                ...
                case CENTER:
                    ...
                    turnToHeading(TURN_SPEED,-90);
                    wrist.setPosition(0.8);
                    driveStraight(0.8,80,-90);
                    encoderDrive(0.4,8,-8,-8,8,2);
                    elbowDrive(0.8,84,3.2);
                    clawL.setPosition(0);
                    elbowDrive(DRIVE_SPEED, -25,3.0);
                    encoderDrive(DRIVE_SPEED,21,-21,-21,21,2.0);
                    turnToHeading(TURN_SPEED,-90);
*/
                ...
                case RIGHT:
                    ...
                    clawL.setPosition(0);
                    elbowDrive(DRIVE_SPEED,-25,3.0);
                    encoderDrive(DRIVE_SPEED,26,-26,-26,26,3);
                    turnToHeading(TURN_SPEED,-90);
