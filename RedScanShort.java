        ...
        while (opModeIsActive()) {
            ...
            switch (pipeline.getAnalysis()) {
                case LEFT:
                    ...
                    driveStraight(0.4, 37,90);
                    encoderDrive(0.6,-3,3,3,-3,3);

                    elbowDrive(0.8,80,3.5);
                    clawL.setPosition(0);
                    elbowDrive(0.6,-25,2.5);
                    wrist.setPosition(0.95);
                    encoderDrive(0.6,-24,24,24,-24,3);
                    driveStraight(0.4,6,90);
                    break;
                case CENTER:
                    ...
                    turnToHeading(TURN_SPEED,90);
                    wrist.setPosition(0.8);
                    driveStraight(0.4,34,90);
                    encoderDrive(DRIVE_SPEED,4,-4,-4,4,2);

                    elbowDrive(0.8,78,2.25);
                    clawL.setPosition(0);
                    elbowDrive(0.8,-25,2.5);
                ...
                case RIGHT:
                    ...
                    sleep(300);
                    turnToHeading(TURN_SPEED, 90);
                    driveStraight(DRIVE_SPEED,16.5,90);
                    pixHolder.setPosition(0.5);
                    sleep(500);
                    driveStraight(DRIVE_SPEED,15,90);
                    wrist.setPosition(0.8);
                    encoderDrive(0.6,14,-14,-14,14,1);
                    ...
                    encoderDrive(0.6,20,-20,-20,20,3);
                    sleep(1000);
                    turnToHeading(TURN_SPEED,90);
